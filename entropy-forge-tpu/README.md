...
Below is the execution plot tracking how the processing array drops into global thermal equilibrium, bypassing local optimization traps using stochastically injected noise:
